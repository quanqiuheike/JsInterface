...
public class EasyPermissions {
    ...
    /**
     * 自定义扩展方法，在外部自定义友情提示，不使用easypermission的设置
     * @param object
     * @param requestCode
     * @param perms
     */
    public static void requestPermissions(@NonNull final Object object, final int requestCode, @NonNull final String... perms) {
